...
from if_lexer import tokens  # Assuming fndec_lex contains the necessary tokens
...
def p_error(p):
    if p:
        ...
        print("Syntax error at EOF: Possibly missing ';' at the end of the function declaration")
...
class ParserGUI:
    ...
    def validate_declaration(self):
        ...
        try:
            ...
            if result:
                self.display_result(result, "green")
            else:
